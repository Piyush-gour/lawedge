      ...
      {loading ? (
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
          {news.slice(0, 5).map((item, index) => (
            <div key={index} className="premium-card" style={{ padding: '12px 20px', borderLeft: '4px solid #3b82f6', display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: '20px' }}>
